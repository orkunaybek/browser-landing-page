    ...
    <div class="grid-item card">
      <div class="card-body">
        ...
        <div class="row align-items-center my-4 main-day">
          ...
          <div class="city-img col-4" :class="this.currentWeather.weather"></div>
        </div>
        <input
        ...
        />
        <div class="justify-content-start" v-for="(listItem, index) in list" v-bind:key="index">
          <ForecastItem :listItem="listItem" :celcius="fToCel" :takeDay="takeDay" />
        </div>
      </div>
    </div>
  </div>
